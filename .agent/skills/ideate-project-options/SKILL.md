...
1. Lire `VISION.md`, `DIRECTION.md`, `IDEAS.md`, les decisions et specs pertinentes.
...
- Demande de brainstorm, nouvelles idees, priorisation ou tri d'idees.
- Vision, direction, carnet d'idees et contexte utilisateur.

## Sorties attendues

- Pistes courtes et non redondantes.
- Valeur projet de chaque piste.
- Risques de scope.
...
- Garder `IDEAS.md` comme carnet d'idees non cadrees.
