...
- L'agent `implementation` travaille depuis le worktree d'implementation.
...
- mettre le hub `main` a jour en fast-forward avant cadrage ou mutation documentaire;
- realigner le worktree d'implementation sur le dernier `origin/main` disponible avant de coder ou livrer, sauf si cela ecraserait un chantier non demande.
